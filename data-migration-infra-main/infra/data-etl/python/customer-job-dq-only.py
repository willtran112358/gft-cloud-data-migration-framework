...
#     df = df.withColumn("entity", SqlFuncs.lit("customer")) \
...
# AWSGlueDataCatalog_node1722266405657_df = glueContext.create_data_frame.from_catalog(database="development_staging", table_name="customer")
...
#     Rules = [
#             ColumnLength "first_name" < 257,
#             ColumnLength "middle_name" < 257,
#             ColumnLength "last_name" < 257,
#             ColumnLength "nationality" < 257,
#             ColumnLength "country_of_residence" <257,
#             ColumnLength "country_of_taxation" < 257,
#             ColumnLength "external_customer_id" < 257,
#             IsComplete "id"
#     ]
# """
...
# SqlQuery0 = '''
# select external_customer_id as id, DataQualityRulesPass, DataQualityRulesFail, DataQualityRulesSkip, DataQualityEvaluationResult from myDataSource
# '''
...
# Script generated for node Evaluate Data Quality
EvaluateDataQuality_node1722266434248_ruleset = """
    # Customer table has only one field 'id'
    Rules = [
            ColumnLength 'id' <= 36,
            IsString "id",
            IsUnique "id",
