...
def MyTransform(glueContext, dfc) -> DynamicFrameCollection:
    ...
    .withColumn("source_close_timestamp", SqlFuncs.lit("")) \
...
ChangeSchema_node1718807126102 = ApplyMapping.apply(frame=SelectFromCollection_node1717604327989, mappings=[("account_id", "string", "id", "string"), ("smart_contract_version_id", "string", "smart_contract_version_id", "string"), ("stakeholder_ids", "string", "stakeholder_ids", "string"), ("alias", "string", "alias", "string"), ("status", "string", "status", "string"), ("source_create_timestamp", "date", "source_create_timestamp", "string"), ("source_open_timestamp", "date", "source_open_timestamp", "string"), ("source_close_timestamp", "string", "source_close_timestamp", "string"), ("denomination", "string", "permitted_denominations", "string"), ("global_migration_id", "string", "details", "string"), ("parameter_values", "string", "parameter_values", "string")], transformation_ctx="ChangeSchema_node1718807126102")
...
# Script generated for node AWS Glue Data Catalog
AWSGlueDataCatalog_node1718810962248_df = ChangeSchema_node1718807126102.toDF()
AWSGlueDataCatalog_node1718810962248 = glueContext.write_data_frame.from_catalog(frame=AWSGlueDataCatalog_node1718810962248_df, database="development_migrationdb", table_name="aux_account", additional_options={})
