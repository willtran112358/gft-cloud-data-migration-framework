...
def MyTransform(glueContext, dfc) -> DynamicFrameCollection:
    ...
    df = df.withColumn("entity", SqlFuncs.lit("posting")) \
...
AWSGlueDataCatalog_node1717595121542_df = glueContext.create_data_frame.from_catalog(database="development_staging", table_name="posting")
...
EvaluateDataQuality_node1717595275716_ruleset = """
    ...
    Rules = [
        ...
        IsComplete "client_transaction_id",
        IsComplete "amount",
        IsComplete "currency",
        IsComplete "value_timestamp",
        IsComplete "booking_timestamp"
    ]
"""
